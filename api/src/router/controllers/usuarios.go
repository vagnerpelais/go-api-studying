...
// BuscarUsuarios busca os usuarios salvos no banco
...
func BuscarSeguidores(w http.ResponseWriter, r *http.Request) {
	 ...
	 usuarioID, erro := strconv.ParseUint(paramtros["usuarioId"], 10, 64)
	 if erro != nil {
		respostas.Erro(w, http.StatusBadRequest, erro)
		return
	 }
...
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioIDNoToken != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("não é possivel atualizar a senha de um usuario que não seja seu"))
		return
	}
